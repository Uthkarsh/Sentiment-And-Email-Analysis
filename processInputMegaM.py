...
output = open("MEGAMInput.feat", "w", encoding = "latin1");
...
if preProcess >= 1:
	for line in file:
		if line.split()[0] == "POSITIVE" or line.split()[0] == "SPAM" or line.split()[0] == "1":
			label = "1";
		else:
			label = "0";
		if preProcess == 2:
